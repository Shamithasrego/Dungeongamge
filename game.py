...
class Level:
    ...
    def AddGold(self):
        ...
        GoldCount = 0
        DesiredGoldCount = random.randint(5, 10)
    ...
    # Collect all empty blocks as potential spawns
        ...
        StepCount = 0
        DesiredStepCount = random.randint(5, 10)  # Number of steps to be added

        while StepCount < DesiredStepCount:
            if not EmptyBlocks:
                break
    ...
    def Build(self):
        ...
        self.AddChests()
        self.AddGold()
        self.AddSteps()  # Add this line to include steps
...
Blocks = {
    ...
    'WallHard': Block(4, 'Wall4', None, None, 15, 1, 0, (50, 50, 50)),
    ...
    'Step': Block('S', 'Step', None, None, 0, 0, 0, (150, 75, 0)),  # Brown color for steps
...
def DrawStep(Screen, X, Y):
    StepColor = (150, 75, 0)  # Brown color

    # Draw the step
    step_rect = pygame.Rect(X * GridScaling, Y * GridScaling, GridScaling, GridScaling)
    pygame.draw.rect(Screen, StepColor, step_rect)
